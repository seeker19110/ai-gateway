...
class UpstreamError extends Error {
  constructor(message, statusCode = 500, options = {}) {
    ...
    // Tín hiệu hạn mức đọc từ header của chính phản hồi lỗi này (`x-ratelimit-*`,
    // `anthropic-ratelimit-*`). Một 429 thường kèm luôn mốc hồi lại, và đó là con số
    // chính xác hơn mọi giá trị mặc định mà bảng cooldown có thể đoán.
